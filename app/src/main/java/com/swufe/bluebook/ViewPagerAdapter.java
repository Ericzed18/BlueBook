...
public class ViewPagerAdapter extends PagerAdapter{
    ...
    public ViewPagerAdapter(List<SystemTask> lists, Context context) {
        this.lists = lists;
    ...
    public Object instantiateItem(@NonNull ViewGroup container, final int position) {
        ...
        tv2.setText(lists.get(position).getTaskDescription());
        Picasso.with(context).load(lists.get(position).getCoverUrl()).fit().into(imageView);
        ...
        cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                config.putExtra("owntask",lists.get(position));
